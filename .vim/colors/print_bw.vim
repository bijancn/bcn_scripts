...
highlight Constant	    cterm=bold ctermfg=black ctermbg=white guifg=black guibg=white
...
highlight Function	    cterm=bold ctermfg=black ctermbg=white guifg=black guibg=white

highlight Statement	    cterm=bold ctermfg=black ctermbg=white guifg=black guibg=white
highlight Conditional	cterm=bold ctermfg=black ctermbg=white guifg=black guibg=white
highlight Repeat	    cterm=bold ctermfg=black ctermbg=white guifg=black guibg=white
highlight Label		    cterm=bold ctermfg=black ctermbg=white guifg=black guibg=white
highlight Operator	    cterm=bold ctermfg=black ctermbg=white guifg=black guibg=white
" Keyword defaults to Statement
" Exception defaults to Statement

highlight PreProc	    ctermfg=black ctermbg=white gui=bold guifg=black guibg=white
" Include defaults to PreProc
" Define defaults to PreProc
" Macro defaults to PreProc
" PreCondit defaults to PreProc

highlight Type		    ctermfg=black ctermbg=white gui=bold guifg=black guibg=white
