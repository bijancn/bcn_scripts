...
syn keyword fortranStatement contained return exit cycle if stop private extends import associate end print read open close inquire rewind use deallocate allocate nullify select case while where elsewhere forall
syn keyword fortranBuiltin contained present associated allocated len max min minloc minval int char trim sin cos tan sinh cosh tanh tan2 sqrt huge epsilon any abs size all
