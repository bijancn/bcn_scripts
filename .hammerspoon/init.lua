...
hs.hotkey.bind(hyper, "c", function() hs.application.launchOrFocus("Cron") end)
...
hs.hotkey.bind(hyper, "m", function() hs.application.launchOrFocus("Spark Desktop") end)
...
hs.hotkey.bind(hyper, "t", function() hs.application.launchOrFocus("Toggl Track") end)
